document.addEventListener('DOMContentLoaded', () => {
    ...
    // Configuration
    const versions = ['latest', 'preview', 'v24', 'v23', 'v22', 'v21', 'v20', 'v19', 'v18', 'v17','v16', 'v15', 'v14', 'v13', 'v12', 'v11', 'v10', 'v9', 'v8', 'v7', 'v6', 'v5', 'v4', 'v3', 'v2', 'v1'];
    ...
    function getRandomPosition() {
        return {
            x: Math.random() * (container.clientWidth - starPadding * 2) + starPadding,
            y: Math.random() * (container.clientHeight - starPadding * 2) + starPadding,
        };
    }
